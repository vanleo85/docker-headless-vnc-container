...
if [ "$ONEC_VERSION" = "8.3.20.2290" ]; then
    ...
    exit 0
elif [ "$ONEC_VERSION" = "8.3.24.1761" ]; then
    echo "Downloading over yandex cloud"
    mkdir -p /tmp/downloads/platform83/8.3.24.1761
    wget --no-check-certificate -q -x -O /tmp/downloads/platform83/8.3.24.1761/server64_8_3_24_1761.zip https://getfile.dokpub.com/yandex/get/https://disk.yandex.ru/d/zIwPbY3m3qgl_Q
    exit 0
    ...
    wget --no-check-certificate -q -x -O /tmp/downloads/platform83/8.3.23.1912/server64_8_3_23_1912.tar.gz https://getfile.dokpub.com/yandex/get/https://disk.yandex.ru/d/spJLJjjz65U72Q
    exit 0
elif [ "$ONEC_VERSION" = "8.3.22.2239" ]; then
    echo "Downloading over yandex cloud"
    mkdir -p /tmp/downloads/platform83/8.3.22.2239
    wget --no-check-certificate -q -x -O /tmp/downloads/platform83/8.3.22.2239/server64_8_3_22_2239.tar.gz https://getfile.dokpub.com/yandex/get/https://disk.yandex.ru/d/M9_ODw7uIitDWA
    exit 0
